...
ALTER TABLE NHACUNGCAP
		---------Bổ sung ràng buộc về định dạng của email, số diện thoại---------
...
INSERT INTO THANHPHO(MATP, TENTP, MAQG)
	...
	('001', N'Hà Nội', 'viVN'),
	('048', N'Đà Nẵng', 'viVN'),
	('046', N'Thừa Thiên Huế', 'viVN'),
	('079', N'Hồ Chí Minh', 'viVN'),
	('045', N'Quảng Trị', 'viVN'),
	('044', N'Quảng Bình', 'viVN'),
	('031', N'Hải Phòng', 'viVN'),
	('037', N'Ninh Bình', 'viVN'),
	('038', N'Thanh Hóa', 'viVN'),
	('040', N'Nghệ An', 'viVN');

-- Bảng Quận/Huyện
INSERT INTO QUANHUYEN(MAQH, TENQH, MATP)
VALUES
	('QH001', N'Quận Ba Đình', '001'),
	('QH002', N'Quận Hoàn Kiếm', '001'),
	('QH003', N'Quận Hải Châu', '048'),
	('QH004', N'Quận Sơn Trà', '048'),
	('QH005', N'Quận Hải An', '031'),
	('QH006', N'Quận Lê Chân', '031'),
	('QH007', N'Huyện Phong Điền', '046'),
	('QH008', N'Huyện Hương Trà', '046'),
	('QH009', N'Huyện Lệ Thủy', '044'),
	('QH010', N'Huyện Quảng Trạch', '044');
...
VALUES
	...
	('KH006', N'Khách hàng cá nhân', N'Nguyễn Văn An', 'PX006', N'987 Lê Duẩn', 'nguyenvana@email.com', '0678901234', '0678901235'),
	('KH007', N'Khách hàng cá nhân', N'Trần Thị Bình', 'PX007', N'147 Nguyễn Du', 'tranthib@email.com', '0789012345', '0789012346'),
...
-- Bảng DONDATHANG
INSERT INTO DONDATHANG (SOHOADON, MAKHACHHANG, MANHANVIEN, NGAYGIAOHANG, NGAYCHUYENHANG, MAPX, DIACHICUTHE) 
VALUES
